...
def make_insort(bisector):
    ...
    True
    >>> f.__name__, f.__qualname__, f.__doc__, f.__annotations__
    ('fake_insort_right', 'fake_insort_right', None, {})
...
def two_sum_int(numbers, total, *, b=16):
    ...
    Traceback (most recent call last):
      ...
    ValueError: no two numbers sum to -63824288
    """  # noqa: E501  # Suppress flake8 line-length warning due to wide table.
