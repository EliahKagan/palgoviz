...
another function produces by resuming, yielding, and suspending.
...
that yields each value that g called f with? h can pass whatever f it likes to
g, but the code of g cannot be modified.
...
a generator function. Here, g is tree.dfs, and f is a any of f_pre, f_in, or
