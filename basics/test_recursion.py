...
# TODO: As a future exercise, convert all tests this class generates into a
#       single-function pytest test function, using @pytest.mark.parametrize.
...
class TestBstCount(unittest.TestCase):
    ...
    def test_count(self, _name, n, expected):
        """The correct number of BSTs is computed."""
